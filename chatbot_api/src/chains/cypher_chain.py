...
# if we were using a paid tier instance of AuraDB, we could work with two replicas of the database, one "master" (which we could use in our ETL pipeline, with both 
